...
ap.add_argument("-a", "--min-area", type=int, default=360, help="minimum area size")
...
cropdir= '/Users/davidli/VolleyDebug/objExtract/basic-motion-detection/ballFrames/'
...
while True:
	...
	out.write(backupFrame)  # write to output video file 
        ...
        #cv2.imshow("original", backupFrame)
